...
<xsl:template match="SMLCL:StateAssignment">				//StateAssignment
					<xsl:value-of select="@variable"/>[num_BRAHMS] = <xsl:call-template name="alias_replace_2"><xsl:with-param name="aliases" select="/SMLCL:SpineML/SMLCL:ComponentClass/SMLCL:Dynamics/SMLCL:Alias"/>
