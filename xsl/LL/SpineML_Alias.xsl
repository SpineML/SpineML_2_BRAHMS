...
<xsl:template match="SMLCL:Alias" mode="doPortAssignmentsAllToAllFixedPreCompute">
					// SMLCL:Alias doPortAssignmentsAllToAllFixedPreCompute section START
					...
					// SMLCL:Alias doPortAssignmentsAllToAllFixedPreCompute section END
</xsl:template>

<xsl:template match="SMLCL:Alias" mode="doPortAssignments">
					// SMLCL:Alias doPortAssignments section START
					...
					// SMLCL:Alias doPortAssignments section END
</xsl:template>
