...
<xsl:param name="spineml_output_dir" select="'../../temp'"/>
...
<xsl:if test="$number1 = number(document(concat($spineml_output_dir,'/counter.file'))/Nums/Number1) and $number2 = number(document(concat($spineml_output_dir,'/counter.file'))/Nums/Number2) and $number3 = number(document(concat($spineml_output_dir,'/counter.file'))/Nums/Number3)">
