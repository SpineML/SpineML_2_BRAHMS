...
<xsl:if test="$number1 = number(document('../../temp/counter.file')/Nums/Number1) and $number2 = number(document('../../temp/counter.file')/Nums/Number2) and $number3 = number(document('../../temp/counter.file')/Nums/Number3)">
