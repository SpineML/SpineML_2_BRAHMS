...
<xsl:template match="SMLCL:StateAssignment">			    //StateAssignment
					<xsl:value-of select="@variable"/>[num] = <xsl:call-template name="alias_replace"><xsl:with-param name="aliases" select="/SMLCL:SpineML/SMLCL:ComponentClass/SMLCL:Dynamics/SMLCL:Alias"/>
