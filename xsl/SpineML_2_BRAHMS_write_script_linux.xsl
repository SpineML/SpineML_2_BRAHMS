...
echo "Building component for population <xsl:value-of select="$number"/>"a
...
chmod +x build
./build
# Clean up component.cpp in case the next xsltproc call fails to create component.cpp
mv component.cpp component.cpp.last
cd - &amp;&gt; /dev/null
...
echo "Building the system..."
xsltproc -o $SPINEML_2_BRAHMS_DIR/temp/sys.xml $XSL_SCRIPT_PATH/HL/SpineML_2_BRAHMS_NL.xsl $SPINEML_2_BRAHMS_DIR/model/$INPUT
echo "Building the execution..."
