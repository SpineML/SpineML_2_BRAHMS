...
xsltproc -o $SPINEML_2_BRAHMS_DIR/temp/component.cpp --stringparam spineml_2_brahms_dir $SPINEML_2_BRAHMS_DIR $XSL_SCRIPT_PATH/LL/SpineML_2_BRAHMS_CL_neurons.xsl $MODEL_DIR/<xsl:value-of select="$model_xml"/>
...
xsltproc -o $SPINEML_2_BRAHMS_DIR/temp/component.cpp --stringparam spineml_2_brahms_dir $SPINEML_2_BRAHMS_DIR $XSL_SCRIPT_PATH/LL/SpineML_2_BRAHMS_CL_weight.xsl $MODEL_DIR/<xsl:value-of select="$model_xml"/>
if [ ! -f component.cpp ]; then
...
xsltproc -o $SPINEML_2_BRAHMS_DIR/temp/component.cpp --stringparam spineml_2_brahms_dir $SPINEML_2_BRAHMS_DIR $XSL_SCRIPT_PATH/LL/SpineML_2_BRAHMS_CL_postsyn.xsl $MODEL_DIR/<xsl:value-of select="$model_xml"/>
if [ ! -f component.cpp ]; then
...
xsltproc -o $SPINEML_2_BRAHMS_DIR/temp/sys.xml --stringparam spineml_2_brahms_dir $SPINEML_2_BRAHMS_DIR $XSL_SCRIPT_PATH/LL/SpineML_2_BRAHMS_NL.xsl $MODEL_DIR/$INPUT
else
...
xsltproc -o $SPINEML_2_BRAHMS_DIR/temp/sys-exe.xml $XSL_SCRIPT_PATH/LL/SpineML_2_BRAHMS_EXPT.xsl $MODEL_DIR/$INPUT
else
...
# run!
echo "Executing: brahms --par-NamespaceRoots=$BRAHMS_NS:$SPINEML_2_BRAHMS_NS:../tools sys-exe.xml"
brahms --par-NamespaceRoots=$BRAHMS_NS:$SPINEML_2_BRAHMS_NS:../tools sys-exe.xml
